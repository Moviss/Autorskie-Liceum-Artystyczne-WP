...
<html lang="pl">
    <head>
        <meta charset="utf-8">
        <title>Ogólnokształcące Liceum Artystyczne - Aktualności</title>
        <meta name="description" content="Aktualności - Liceum Ogólnokształcące o profilu artystycznym jest szkołą,
...
się od Was”. Jest to szkoła tworzona z pasją.">
        ...
        <link rel="stylesheet" href="<?php echo get_bloginfo('template_directory'); ?>/css/sub-site-news.css">
                    ...
                    <ul class="menu">
                        ...
                        <li>
                            ...
                            <ul class="sub-menu">
                                ...
                                <li>
                                    <a href="<?php echo site_url('dlaczego-warto-nas-wybrac') ?>">Dlaczego warto nas wybrać?</a>
                                </li>
                                <li>
